  ...
  return (
    <>
      ...
      <p>
        ...
        <a
          href="https://github.com/polkadot-cloud/frontpage/blob/main/packages/assets/lib/validators/index.ts"
          target="_blank"
          rel="noreferrer"
        >
      ...
      <Note>
        <p>
          ...
          <a
            href="https://github.com/polkadot-cloud/frontpage/tree/main/packages/assets#adding-validator-operators"
            target="_blank"
            rel="noreferrer"
          >
            README file
